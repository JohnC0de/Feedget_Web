  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 md:min-w-[304px] w-full">
        ...
        <span className="mt-2 text-xl">Adradecemos o feedback!</span>

        <button
          type="button"
          onClick={onFeedbackRestartRequested}
          className="px-6 py-2 mt-6 text-sm leading-6 transition-colors border-transparent rounded-md bg-zinc-800 hover:bg-zinc-700 focus:ring-2 focus:outline-none focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand"
        >
          Quero enviar outro
        </button>
      </div>
